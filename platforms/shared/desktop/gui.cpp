...
static void set_style_light(ImGuiStyle& style)
{
    ...
    const ImVec4 accent_soft = make_color(0xFFE4BF);
    const ImVec4 accent_hover = make_color(0xFFDFB5);
    const ImVec4 accent_selected = make_color(0xFFD19A);
    const ImVec4 accent_edge = make_color(0xEC9455);
    const ImVec4 accent_ink = make_color(0xB94700);
    const ImVec4 accent_strong = make_color(0x582D1D);
    const ImVec4 accent_bright = make_color(0xFF8D00);
    ...
    style.Colors[ImGuiCol_ResizeGripHovered] = make_color(0xEC9455, 0.80f);
    style.Colors[ImGuiCol_ResizeGripActive] = make_color(0xB94700, 0.95f);
    ...
    style.Colors[ImGuiCol_NavHighlight] = make_color(0xFF8D00, 0.90f);
    ...
    style.Colors[ImGuiCol_DockingPreview] = make_color(0xFF8D00, 0.45f);
