...
static const McpToolCategory kMcpToolCategories[] =
{
    ...
    {"breakpoints", "Breakpoints", "Set, clear, and list CPU execution/read/write/range breakpoints and Mikey timer IRQ breakpoints."},
    ...
    {"cpu", "CPU", "Inspect 6502 registers, flags, interrupts, PC, stack, and write CPU register values."},
    ...
    {"hardware_mikey", "Mikey Hardware", "Inspect Atari Lynx Mikey registers, timers, audio channels, interrupts, and system control state."},
    {"hardware_suzy", "Suzy Hardware", "Inspect Atari Lynx Suzy registers, math hardware, sprite metadata, and sprite control blocks."},
    {"hardware_lcd", "LCD Hardware", "Inspect Atari Lynx LCD status, display line timing, visible/VBlank state, pixel, and DMA information."},
    {"hardware_uart", "UART Hardware", "Inspect Atari Lynx UART and ComLynx serial/link-port status."},
    {"hardware_cartridge", "Cartridge Hardware", "Inspect Atari Lynx cartridge address generation, banks, AUDIN, EEPROM, and save hardware state."},
    {"media", "Media", "Load ROMs or BIOS files, list recent media, load symbols, and inspect loaded cartridge/media information."},
    {"capture", "Capture", "Capture current screenshots and Lynx debug frame buffers such as VIDBAS and DISPADR."},
    ...
    {"input", "Input", "Inspect, press, release, tap, or macro Atari Lynx input."},
    {"trace", "Trace", "Read trace log entries and configure CPU, IRQ, Suzy, Mikey, UART, audio, cart, and debug-message tracing."},
...
static const char* const kMcpBreakpointTools[] =
{
    ...
    "set_breakpoint_on_irq", "clear_breakpoint_on_irq", "list_breakpoints_on_irq"
};
...
{
    "get_6502_status", "write_6502_register"
};
...
static const char* const kMcpMikeyTools[] =
{
    "get_mikey_registers", "write_mikey_register", "get_mikey_timers", "get_mikey_audio"
};

static const char* const kMcpSuzyTools[] =
{
    "get_suzy_registers", "write_suzy_register", "get_sprite"
};
...
static const char* const kMcpUartTools[] =
{
    "get_uart_status"
};

static const char* const kMcpCartridgeTools[] =
{
    "get_cart_status", "get_eeprom_status"
};
...
{
    "get_screenshot", "get_frame_buffer"
};
...
static const McpToolCategoryTools kMcpToolCategoryTools[] =
{
    ...
    {"hardware_mikey", kMcpMikeyTools, MCP_ARRAY_COUNT(kMcpMikeyTools)},
    {"hardware_suzy", kMcpSuzyTools, MCP_ARRAY_COUNT(kMcpSuzyTools)},
    {"hardware_lcd", kMcpLcdTools, MCP_ARRAY_COUNT(kMcpLcdTools)},
    {"hardware_uart", kMcpUartTools, MCP_ARRAY_COUNT(kMcpUartTools)},
    {"hardware_cartridge", kMcpCartridgeTools, MCP_ARRAY_COUNT(kMcpCartridgeTools)},
