# Gearlynx iOS User Guide

## Supported games and controls

- Supported files: `.lnx`, `.lyx`, `.o`, `.bin`, and `.zip`.
- Controls: directional pad, A, B, Option 1, Option 2, and Pause.
- One connected Apple-compatible game controller can be used for Player 1.
- A `lynxboot.img` BIOS is required and must be exactly 512 bytes.
- Import the BIOS from **Settings → Firmware** before opening a game.
